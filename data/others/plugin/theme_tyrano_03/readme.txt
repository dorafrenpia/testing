...
プロジェクトフォルダの
data/others/plugin
に解凍したtheme_tyrano_03フォルダを配置します。
...
機能ボタンの位置や不要なボタンなどは
theme_tyrano_03フォルダの中にある、init.ks を編集することでカスタマイズできます。

また、プラグインロード時に引数を渡すこともできます。


（例）
[plugin name="theme_tyrano_03" font_color="0xFFFFFF" name_color="0xFFCC00"  frame_opacity="255" ]
...
colorにtheme_tyrano_03を指定して下さい。

[glink  color="theme_tyrano_03"  storage="scene1.ks"  size="20"  x="260"  width="400"  y="100"  text="はい。興味あります"  target="*selectinterest"  ]
[glink  color="theme_tyrano_03"  storage="scene1.ks"  size="20"  x="260"  width="400"  y="170"  text="興味あります！"  target="*selectinterest"  ]
[glink  color="theme_tyrano_03"  storage="scene1.ks"  size="20"  x="260"  width="400"  y="240"  text="どちらかと言うと興味あり"  target="*selectinterest"  ]
[s  ]
...
[button x=166 y=507 graphic="title/button_config.gif" storage="../others/plugin/theme_tyrano_03/config.ks" role="sleepgame"]
...
;CGモードへのジャンプ
[button x=166 y=408 graphic="title/button_cg.gif"  storage="../others/plugin/theme_tyrano_03/replay.ks"]
;回想モードへのジャンプ
[button x=486 y=408 graphic="title/button_replay.gif" storage="../others/plugin/theme_tyrano_03/replay.ks"]

;コンフィグ画面へのジャンプ
[button x=166 y=507 graphic="title/button_config.gif" role="sleepgame" storage="../others/plugin/theme_tyrano_03/config.ks"]
